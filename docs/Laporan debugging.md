...
| 2 | `Table 'perpustakaan.anggota' doesn't exist` | Data sudah ada tapi tidak tersammbung dengan baik | Memastikan AnggotaDAO.java BukuDAO.java PeminjamanDAO.java Tersambung dengan baik |  |
